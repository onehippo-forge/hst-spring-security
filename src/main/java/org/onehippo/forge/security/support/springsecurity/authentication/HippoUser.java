...
public class HippoUser extends User {
    ...
    public HippoUser(String username, String password, Collection<? extends GrantedAuthority> authorities, Map<String, Object> props) {
    ...
    public HippoUser(String username, String password, boolean enabled, boolean accountNonExpired,
            ...
            Collection<? extends GrantedAuthority> authorities, Map<String, Object> props) {
