 ...
 */
public class HippoUserDetailsService implements UserDetailsService {

    static final Logger log = LoggerFactory.getLogger(HippoUserDetailsService.class);
    ...
    public HippoUserDetailsService() {
    }
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException, DataAccessException {
        return loadUserByUsernameAsUserAndPassword(username, null);
    }

    public User loadUserByUsernameAsUserAndPassword(String username, String password) throws UsernameNotFoundException, DataAccessException {
        User user = null;
